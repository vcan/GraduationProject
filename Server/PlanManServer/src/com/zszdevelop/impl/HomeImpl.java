		...
		try {
			...
			if (rs.next()) {// 如果有值，把值塞进去返回。
				...
				while (rsQueryGoalRecordInfo.next()) {
					...
					goalRecordInfo.setGoalRecordChest(rsQueryGoalRecordInfo.getFloat("goalRecordChest"));
					goalRecordInfo.setGoalRecordLeftArm(rsQueryGoalRecordInfo.getFloat("goalRecordLeftArm"));
					goalRecordInfo.setGoalRecordRightArm(rsQueryGoalRecordInfo.getFloat("goalRecordRightArm"));
					goalRecordInfo.setGoalRecordLoin(rsQueryGoalRecordInfo.getFloat("goalRecordLoin"));
					goalRecordInfo.setGoalRecordShoulder(rsQueryGoalRecordInfo.getFloat("goalRecordShoulder"));
					goalRecordInfo.setGoalRecordWeight(rsQueryGoalRecordInfo.getFloat("goalRecordWeight"));
