...
public class API {
    ...
    public static final String SERVER_URI = "http://172.20.10.11:8080/PlanManServer/%s";
    public static final String SERVER_DEBUG_URI = "http://172.20.10.11:8080/PlanManServer/%s";
